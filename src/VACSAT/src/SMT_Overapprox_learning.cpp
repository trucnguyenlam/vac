...
//
//    typedef std::list<int> trace;
//    template <typename TVar, typename TExpr>
//    struct nondet_id {
//        const trace id;
//        const TVar model_var;
//        bool used;
//        nondet_id(trace _id, TVar _variable) :
//            id(_id),
//            model_var(_variable),
//            used(false) { }
//    };
...
//
//template <typename TVar, typename TExpr>
//class LearningOverapproxTransformer {
//    private:
//
//    struct RoleChoicer {
//        enum Choice {
...
//    }
//
//    std::vector<nondet_id<TVar, TExpr>> evaluate_nondet_ids() {
//
//    };
//
//
//    public:
//    LearningOverapproxTransformer(const std::shared_ptr<SMTFactory<TVar, TExpr>> _solver,
//                                  const std::shared_ptr<arbac_policy>& _policy,
...
//    }
//
//    ~LearningOverapproxTransformer() = default;
//
//    std::pair<bool, std::vector<nondet_id<TVar, TExpr>>> apply() {
...
//            return std::pair<bool, std::vector<nondet_id<TVar, TExpr>>>(false, std::vector<nondet_id<TVar, TExpr>>());
//        }
//        if (ret) {
//            log->info("Target role may be reachable");
//            return std::pair<bool, std::vector<nondet_id<TVar, TExpr>>>(ret, evaluate_nondet_ids());;
//        }
//        else {
//            log->info("Target role is not reachable");
//            return std::pair<bool, std::vector<nondet_id<TVar, TExpr>>>(false, std::vector<nondet_id<TVar, TExpr>>());
...
//
//    template <typename TVar, typename TExpr>
//    bool smart_overapprox(const std::shared_ptr<SMTFactory<TVar, TExpr>>& solver,
//                          const std::shared_ptr<arbac_policy>& policy,
//                          const Expr& to_check) {
//        solver->deep_clean();
...
//            return false;
//        }
//        LearningOverapproxTransformer<TVar, TExpr> transf(solver, policy, to_check);
...
//
//    template <typename TVar, typename TExpr>
//    bool learning_overapprox(const std::shared_ptr<SMTFactory<TVar, TExpr>>& solver,
//                          const std::shared_ptr<arbac_policy>& policy,
//                          const Expr& to_check) {
//
//        return smart_overapprox(solver, policy, to_check);
//    }
//
//
//    template bool learning_overapprox<term_t, term_t>(const std::shared_ptr<SMTFactory<term_t, term_t>>& solver,
//                                                   const std::shared_ptr<arbac_policy>& policy,
//                                                   const Expr& to_check);
//
//    template bool learning_overapprox<expr, expr>(const std::shared_ptr<SMTFactory<expr, expr>>& solver,
//                                               const std::shared_ptr<arbac_policy>& policy,
//                                               const Expr& to_check);
//
//    template bool learning_overapprox<BoolectorExpr, BoolectorExpr>(const std::shared_ptr<SMTFactory<BoolectorExpr, BoolectorExpr>>& solver,
//                                                                 const std::shared_ptr<arbac_policy>& policy,
//                                                                 const Expr& to_check);
//
//    template bool learning_overapprox<msat_term, msat_term>(const std::shared_ptr<SMTFactory<msat_term, msat_term>>& solver,
//                                                         const std::shared_ptr<arbac_policy>& policy,
//                                                         const Expr& to_check);
//
//}

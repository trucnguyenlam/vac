...
/*!
  ...
  .. code-block:: c
    ...
    for (s = boolector_first_opt_noref (btor); boolector_has_opt_noref (btor, s); s = boolector_next_opt_noref (btor, s)) {...} 
...
*/
BoolectorNode *boolector_unsigned_int (Btor * btor, unsigned u,
                                       BoolectorSort sort);
...
/*!
  ...
  .. note::
    ...
    (boolector_release).
*/ 
BoolectorNode *boolector_match_node_by_symbol (Btor * btor,
                                               const char * symbol);
...
*/
bool boolector_is_equal_sort (Btor * btor,
                              BoolectorNode * n0,
                              BoolectorNode * n1);

...
public:
  ...
  enum {
    RuleR_start = 0, RuleR_user = 1, RuleUser_element = 2, RuleR_attr = 3, 
    RuleAttr_element = 4, RuleR_init = 5, RuleInit_element = 6, RuleInit_assignment = 7, 
    RulePrimaryExpression = 8, RuleUnaryExpression = 9, RuleEqualityExpression = 10, 
    RuleAndExpression = 11, RuleOrExpression = 12, RuleImplyExpression = 13, 
    RuleConditionalExpression = 14, RuleExpression = 15, RuleR_rules = 16, 
    RuleRule_element = 17, RuleNormal_assignment = 18, RulePrecondition = 19, 
    RuleR_query = 20
  };

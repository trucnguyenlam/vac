...
class hierarchygrammarListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by hierarchygrammarParser#order.
    def enterOrder(self, ctx):
        pass

    # Exit a parse tree produced by hierarchygrammarParser#order.

...
bool LocalInit(
  ...
  t < l
(false 
| ((/* pc=0 */ t.b1=0 & t.b2=0 & t.b3=0)& l.target=false& l.SUPER_ROLE=true& l.ToCheckRole=true& l.TargetPrime=false)
| ((/* pc=1 */ t.b1=1 & t.b2=0 & t.b3=0)& l.target=false& l.SUPER_ROLE=false& l.ToCheckRole=false& l.TargetPrime=false)
);
#size LocalInit;
...
(cG.ToCheckRole=true & cL.ToCheckRole=true & cL.target=true & cL.TargetPrime=false) & /* Applying this rule */
 (dL.TargetPrime=true)
/* Copy variables */
& (dL.target=cL.target)& (dL.SUPER_ROLE=cL.SUPER_ROLE)& (dL.ToCheckRole=cL.ToCheckRole))
);
#size CanAssign;

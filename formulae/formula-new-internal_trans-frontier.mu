...
mu bool Frontier(
 ...
 s_ID    <  s_G
(
     Sequ_Reach(1, s_block, s_r, s_ID, s_G)        // s is reachable
  & !Sequ_Reach(0, s_block, s_r, s_ID, s_G)
);

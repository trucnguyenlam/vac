...
class Globals{     // Thread interface
 Roles  g0;    // round 0
 Roles  h0;    // round 0
 Roles  g1;    // round 1
 Roles  h1;    // round 1
...
( false
  ...
  | ( exists    /* Sequ_Reach::@Exists0 */               // There exists a state such that
        ...
        (   Sequ_Reach( t_block, t_r, t_ID, t_CL, t_G )    // That state is in fixed point and ...
          & Fake_Ordering_All (t_block, t_r, t_ID, t_CL, t_G, s_block, s_r, s_ID, s_CL, s_G)
  ...
  |  (  // For the first round
        ...
        & GlobalInit(s_G.g0)
        & LocalInit(s_ID, s_CL)        // init of local variables
...
*/
  ...
  | ( // WRLI block generates by an TLI (LHS)
       ...
       & ( exists     /* Sequ_Reach::@Exists3 */
            ...
            (   Sequ_Reach( have, t_r, s_ID, s_CL, s_G ) //HAVE means RLI
              & increaseCS( t_r, s_r )
            )
         )
...
*/
  ...
  |  (   // round 0 execution of any thread except thread0
       ...
       & ( exists         /* Sequ_Reach::@Exists5 */    // The ordering has some problem (s_G is not mixed with t_G)
              ...
              Globals  t_G.
            (
              Sequ_Reach( threadnoloc, s_r, t_ID, t_CL, t_G )    // After a thread finishes its execution
  ...
  | ( // increase ROUND for TLI (not thread0, not the last thread)
      ...
      & ( exists        /* Sequ_Reach::@Exists6 */
             CS t_r.
            (   Sequ_Reach( thread, t_r, s_ID, s_CL, s_G )   // TLI
              & increaseCS( t_r, s_r )
            )
        )
...
//               & (
//                   ( CanRevoke_0( t_CL, t_G, s_CL )
//                   | CanAssign_0( t_CL, t_G, s_CL )
//                   | UpdateGlobal_0( s_CL, t_G, s_G )
//                   )
//                 )
//            )
//       )
...
//               & (
//                   ( CanRevoke_1( t_CL, t_G, s_CL )
//                   | CanAssign_1( t_CL, t_G, s_CL )
//                   | UpdateGlobal_1( s_CL, t_G, s_G )
//                   )
//                 )
//            )
//       )
...
//               & (
//                   ( CanRevoke_2( t_CL, t_G, s_CL )
//                   | CanAssign_2( t_CL, t_G, s_CL )
//                   | UpdateGlobal_2( s_CL, t_G, s_G )
//                   )
//                 )
//            )
//       )
...
//               & (
//                   ( CanRevoke_3( t_CL, t_G, s_CL )
//                   | CanAssign_3( t_CL, t_G, s_CL )
//                   | UpdateGlobal_3( s_CL, t_G, s_G )
//                   )
//                 )
//            )
//       )
...
//*************** Round 0
  ...
  |  (
      ...
      & (exists        /* Sequ_Reach::@Exists17 */              // There exists an internal state that
           Globals t_G.
           (  (  Sequ_Reach( s_block, s_r, s_ID, s_CL, t_G )
              & copy_g_and_h_0( s_G, t_G )
              )
            & ( UpdateGlobal( s_CL, t_G.h0, s_CL, s_G.h0 )
              )
           )
      )
    )
 ...
 |  (
      ...
      & (exists      /* Sequ_Reach::@Exists20 */              // There exists an internal state that
           ...
           (  (  Sequ_Reach( s_block, s_r, s_ID, s_CL, t_G )
            ...
            & ( UpdateGlobal( s_CL, t_G.h1, s_CL, s_G.h1 )
              )
           )
      )
    )
 ...
 |  (
      ...
      & (exists         /* Sequ_Reach::@Exists23 */            // There exists an internal state that
           ...
           (  (  Sequ_Reach( s_block, s_r, s_ID, s_CL, t_G )
            ...
            & ( UpdateGlobal( s_CL, t_G.h2, s_CL, s_G.h2 )
              )
           )
      )
    )
  ...
  |  (
      ...
      & (exists        /* Sequ_Reach::@Exists26 */            // There exists an internal state that
           ...
           (  (  Sequ_Reach( s_block, s_r, s_ID, s_CL, t_G )
            ...
            & ( UpdateGlobal( s_CL, t_G.h3, s_CL, s_G.h3 )
              )
           )
      )
    )
